"""
Django settings for cold_term_41496 project.
...
ROOT_URLCONF = 'cold_term_41496.urls'
...
WSGI_APPLICATION = 'cold_term_41496.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_term_41496 API",
    "DESCRIPTION": "API documentation for cold_term_41496 App",
    "VERSION": "v1",
}
